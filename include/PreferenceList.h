...
public:
    ...
    void emplace_back_ties(VertexPtr v, bool same_rank);
    ...
    /// functions to return the vertex and rank from a given index
    ...
    bool is_ranked_better_ties(VertexPtr a, VertexPtr b);
